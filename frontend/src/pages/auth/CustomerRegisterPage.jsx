...
function CustomerRegisterPage() {
  ...
  return (
    <div className="w-full py-4">
      <p className="eyebrow text-clay">Customer registration</p>
      <h1 className="mt-4 font-display text-5xl tracking-tight text-indigo">Create your account.</h1>
      <p className="mt-4 text-sm leading-6 text-muted">Save favourites, follow orders, and discover independent makers.</p>
